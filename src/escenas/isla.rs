...
impl Guion for Isla {
    fn escena(&mut self) -> Escena {
        ...
        e.pintar(Instr::Relleno { pintura: color(0.04, 0.043, 0.045).into(), alfa: 1.0.into(), filo: 0.06, luz: None, borde: None, vidrio: None });
        ...
        e.superficies = vec![Superficie { alto: 140, ..Default::default() }];
        e
    }
