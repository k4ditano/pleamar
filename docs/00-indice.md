...
La barra enseña lo que falta para usarla a diario, y está todo en [[pleamar · 08 Limitaciones conocidas]]: **más servicios** (B1: audio, música, batería, red, notificaciones, bandeja), **la entrada que falta** (S6: rueda para el volumen, teclado, arrastrar), **una instancia por monitor** (S2/B2) y **permisos** para la lógica (U1).
