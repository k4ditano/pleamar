...
Lo que queda rojo en [[pleamar · 08 Limitaciones conocidas]]: **un campo donde escribir** (E2: sin él no hay lanzador ni buscador), **más servicios** (B1: audio de verdad, música, batería, red, notificaciones, bandeja), **permisos** para la lógica (U1) y los **topes fijos** del render (P7). Y por debajo, una instancia de escena por monitor (S2).
