...
- ⬜ más servicios, IME, ventanas normales y menús: ver la nota 07.

## Siguiente paso

Lo que queda rojo en [[pleamar · 08 Limitaciones conocidas]]: **más servicios** (B1: audio de verdad, música, batería, red, notificaciones, bandeja), **permisos** para la lógica (U1) y los **topes fijos** del render (P7). Y por debajo, una instancia de escena por monitor (S2), el IME (E7) e imágenes que vengan de datos (T12). **Por probar con manos de verdad**: el lanzador con su bind y el teclado exclusivo (E8).
